...
class FigurinhaExtra extends Figurinha {
    ...
    public FigurinhaExtra(Figurinha figurinha, String raridade, String cor) {
        super(figurinha.getNomeDoJogador(), figurinha.getDataDeNascimento(), figurinha.getAltura(), figurinha.getPeso(), figurinha.getPosicao(), figurinha.getPais());
        this.raridade = raridade;
        this.cor = cor;
    }
